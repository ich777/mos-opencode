...
functions, configuration files (such as `settings.json`) and wrapper scripts
to integrate OpenCode within MOS.
...
`opencode` itself is licensed under its respective upstream license.
